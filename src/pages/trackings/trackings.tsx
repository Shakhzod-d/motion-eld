import { CustomTable, Map, TrackingMap } from "../../components/shared";
import { WrapperDtaa } from "../../components/shared/tracking-map/tracking-styled";
...
export function Trackings() {
  return (
    <WrapperDtaa>
      {/* <TrackingMap /> */}
      <CustomTable data={trackingData} columns={trackingHeader} />
      <div style={{ marginTop: "50px" }}>
        <Map mapData={truckData} activeId={1} />
      </div>
    </WrapperDtaa>
  );
}
